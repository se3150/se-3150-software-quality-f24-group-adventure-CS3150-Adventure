...
class Room:
    def __init__(self):
        ...
        self.questions = [
            {"question": "The Atlantic Ocean is the largest ocean in the world. (True/False)", "answer": True, "hint": "Think about the Pacific Ocean’s size compared to others."},
            {"question": "A triangle with two equal sides is called an isosceles triangle. (True/False)", "answer": False, "hint": "The name comes from Greek for 'equal legs'."},
